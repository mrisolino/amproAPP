...
var AddonModForumIndexPage = /** @class */ (function () {
    ...
    AddonModForumIndexPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-addon-mod-forum-index',template:/*ion-inline-start:"C:\github\amApp\src\addon\mod\forum\pages\index\index.html"*/'<ion-header>\n\n    <ion-navbar>\n\n        <ion-title><core-format-text [text]="title"></core-format-text></ion-title>\n\n\n\n        <ion-buttons end>\n\n            <!-- The buttons defined by the component will be added in here. -->\n\n        </ion-buttons>\n\n    </ion-navbar>\n\n</ion-header>\n\n\n\n<addon-mod-forum-index [module]="module" [courseId]="courseId" (dataRetrieved)="updateData($event)"></addon-mod-forum-index>\n\n'/*ion-inline-end:"C:\github\amApp\src\addon\mod\forum\pages\index\index.html"*/,
        }),
