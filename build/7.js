...
var CoreViewerImagePage = /** @class */ (function () {
    ...
    CoreViewerImagePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-core-viewer-image',template:/*ion-inline-start:"C:\github\amApp\src\core\viewer\pages\image\image.html"*/'<ion-header>\n\n    <ion-navbar>\n\n        <ion-title>{{ title }}</ion-title>\n\n\n\n        <ion-buttons end>\n\n            <button ion-button icon-only (click)="closeModal()" [attr.aria-label]="\'core.close\' | translate">\n\n                <ion-icon name="close"></ion-icon>\n\n            </button>\n\n        </ion-buttons>\n\n    </ion-navbar>\n\n</ion-header>\n\n<ion-content padding>\n\n    <img [src]="image" alt="{{ title }}" core-external-content [component]="component" [componentId]="componentId">\n\n</ion-content>\n\n'/*ion-inline-end:"C:\github\amApp\src\core\viewer\pages\image\image.html"*/,
        }),
