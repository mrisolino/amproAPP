...
var AddonModImscpIndexPage = /** @class */ (function () {
    ...
    AddonModImscpIndexPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-addon-mod-imscp-index',template:/*ion-inline-start:"C:\github\newAC\src\addon\mod\imscp\pages\index\index.html"*/'<ion-header>\n\n    <ion-navbar core-back-button>\n\n        <ion-title><core-format-text [text]="title"></core-format-text></ion-title>\n\n\n\n        <ion-buttons end>\n\n            <!-- The buttons defined by the component will be added in here. -->\n\n        </ion-buttons>\n\n    </ion-navbar>\n\n</ion-header>\n\n<ion-content>\n\n    <addon-mod-imscp-index [module]="module" [courseId]="courseId" (dataRetrieved)="updateData($event)"></addon-mod-imscp-index>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\github\newAC\src\addon\mod\imscp\pages\index\index.html"*/,
        }),
